...
require_once("../../controller/mostrarUser.php");
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="homeUsuario.php" class="nav-link">Home</a>
      </li>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Editar Perfil Usuario</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                ...
                <form action="../../controller/modificarClaveU.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                     <div class="row">
                          ...
                          <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control" id="clave" name="claveActual"  required>
                          </div>
                          <div class="form-group col-md-12">
                            <label for="clave">Clave Nueva</label>
                            <input type="text" class="form-control" id="clave" name="newClave"  required>
                          </div>
                          <div class="form-group col-md-12">
                            <label for="clave">Confirmar Clave</label>
                            <input type="text" class="form-control" id="clave" name="confClave" required>
                          </div>
