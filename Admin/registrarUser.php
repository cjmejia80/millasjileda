                ...
                <div class="card-body">
                     <div class="row">
                          ...
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" id="nombres" name="nombres" placeholder="Ej:Ana Maria" required>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="apellidos">Apellidos</label>
                            <input type="text" class="form-control" id="apellidos" name="apellidos" placeholder="Ej:Perez" required>
                          </div>
                          <div class="form-group col-md-6">
                            <label for="fecha_nacimiento">Fecha de Nacimiento</label>
                            <input type="date" values="2000/01/01"class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="12/12/2001" required>
                          </div>
                          <div class="form-group col-md-6">
