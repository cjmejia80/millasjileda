...
$result = $objetoConsultas -> mostrarUsuarios();
//var_dump($result);
//die();
?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Seleccionar Usuario</h1>
          </div><!-- /.col -->
          </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
          ...
          <div class="col-md-6">
              ...
              <!-- form start -->
                     ...
                     <div class="row">
                        ...
                        <select name="user_id" id="user_id" class="form-select">
                          ...
                          <?php
                            foreach($result as $f ){
                            ?>
                          <option value="<?php echo $f["Identificacion"]?>"><?php echo $f["Nombres"]?> <?php echo $f["Apellidos"]?> </option>
                          <?php
                          }
                           ?>
                        </select>
                ...
                <div class="card-footer">
                  ...
                  <a href="registrarPlanillaForm.php"  class="btn btn-primary" onclick="location.href=this.href+'?user_id='+ObtenerValor();return false;">Aceptar</a>
                </div>
...
<script type="text/javascript">
	function ObtenerValor() {
		var valor = document.getElementById('user_id').value;
		return valor;
    //console.log(valor);
	}
</script>
