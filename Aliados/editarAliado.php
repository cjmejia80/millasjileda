...
require_once("../../controller/mostrarAliadoA.php");
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Editar Perfil Aliado</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="card card-primary">
              <div class="card-header">
                ...
                <form action="../../controller/modificarClaveA.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                     <div class="row">
