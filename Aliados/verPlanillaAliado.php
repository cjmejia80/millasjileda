...
require_once("../../controller/mostrarPlanillaAliado.php")
?>
...
<head>
  ...
  <title>Panillas Registradas </title>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12">
            <h1 class="m-0">Planillas Registradas</h1>
          </div><!-- /.col -->
...
<script>
  $(function () {
    $("#tableplanilla_puntos").DataTable({
      "responsive": true, "lengthChange": false, "autoWidth": false,
      "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"]
    }).buttons().container().appendTo('#tableplanilla_puntos_wrapper .col-md-6:eq(0)');
    $('#example2').DataTable({
      "paging": true,
      "lengthChange": false,
      "searching": false,
